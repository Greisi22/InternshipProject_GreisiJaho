                                ...
                                <tr
                                    ...
                                    <td className="px-6 whitespace-nowrap">
                                        <div className="flex space-x-2 items-center">
                                            {/* Print Button */}
                                            <button className="btn btn-primary-print" onClick={() => handlePrintBill(restaurant.id)} style={{ width: '36%', padding: '12px', fontSize: '16px', borderRadius: '6px', cursor: 'pointer', backgroundColor: '#16C098', color: '#fff' }}>Print</button>
                                            {/* Edit Button */}
                                            <img
                                                src={editIcon}
                                                alt="Edit Icon"
