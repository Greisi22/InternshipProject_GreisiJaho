    ...
    return (
        <div>
            ...
            <div className="w-full mt-4 flex justify-center">
               <span className='cursor-pointer hover:bg-[#e94339] hover:text-white flex justify-center w-[40px] pl-[10px] rounded-3xl h-[35px] align-middle pt-[4px]'> <ArrowBackIosIcon/></span>
                <span className='ml-8 mr-8'></span>
                <span className='cursor-pointer hover:bg-[#e94339] hover:text-white flex justify-center w-[40px] pl-[10px] rounded-3xl h-[35px] align-middle pt-[4px] pr-[6px]'><ArrowForwardIosIcon /></span>
            </div>
        </div>
    );
}
