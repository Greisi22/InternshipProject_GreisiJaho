    ...
    return (
        <div className="flex flex-row overflow-x-auto h-52 restarant-wrapper">
            ...
            <div className="overflow-hidden snap-center m-2 w-96 min-w-[320px] relative">
                ...
                <div className="rounded-bl-lg rounded-br-lg rounded-sm absolute w-14 h-10 bg-gray-950 top-0 right-4 bg-darkBlueColor text-gray-50 font-bold flex items-center justify-center transform -translate-x-2/5">
                    -40%
                </div>
            </div>
