...
const Counter = () => {
  return (
    <div className="w-full h-[20vh]  bg-red-200 p-[40px] pl-[80px] pr-[80px] pt-[4px] mt-[100px] first">
      <div className="pt- bg-[#e94339] text-center h-full w-full flex  rounded-tl-md rounded-tr-md rounded-bl-md rounded-br-md div0">
