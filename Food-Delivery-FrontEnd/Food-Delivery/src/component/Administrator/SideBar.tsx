    ...
    const handleItemClick = (item: string) => {
        switch (item) {
            case '1':
                ...
                break;
            case '2':
                navigate('/Administrator/RequestedRestaurantsPage');
                break;
            case '3':
                navigate('/Administrator/RestaurantsPage');
                break;
            case '4':
                navigate('/Administrator/UsersPage');
                break;
            case '5':
                navigate('/Administrator/CreateNewUser');
                break;
            case '6':
                navigate('/Administrator/RevenuesPage');
                break;
            case '7':
                navigate('/Administrator/StatisticsPage');
                break;
            case '8':
                navigate('/Administrator/SettingsPage');
                break;
            default:
                break;
        }
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Restoaurants</span>
                        ...
                        <li>
                            <a
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Revenues</span>
                            </a>
                        </li>
