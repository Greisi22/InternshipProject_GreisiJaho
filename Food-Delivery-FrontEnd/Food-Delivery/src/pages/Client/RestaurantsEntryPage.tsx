...
function NavBar({ allRestaurants, onSearchSelect, onCategorySelect }: { allRestaurants: Restaurant[], onSearchSelect: (restaurant: Restaurant) => void, onCategorySelect: (category: string) => void }) {
        ...
        <nav className="bg-white shadow dark:bg-gray-800">
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                <div className="flex items-center space-x-4">
                    ...
                    <span className="text-xl font-bold text-gray-700 dark:text-gray-300">Tasty Rush</span>
                </div>
                <div className="relative flex items-center w-1/2">
                    ...
                    {isFocused && (
                        <div className="absolute top-full left-0 w-full mt-2 bg-white border rounded-lg shadow-lg z-10 p-4">
                            <div className="mb-2">
                                <strong className="block text-sm text-gray-700 dark:text-gray-300">Më të kërkuarat</strong>
                                <ul>
                            ...
                            <div>
                                <strong className="block text-sm text-gray-700 dark:text-gray-300">Kategoritë</strong>
                                <ul>
                                    {[ 'Burger', 'Fast Food', 'Sushi', 'Healthy', 'Restorante', 'Pizza', 'Peshk'].map((category, index) => (
                                        <li
                                            key={index}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-red-500">
                    {filteredRestaurants.map((restaurant, index) => (
                        <div
                            ...
                            className="cursor-pointer flex flex-col bg-red-500 border border-gray-200 rounded-lg shadow hover:bg-red-600 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 active:bg-gray-200"
                        >
                            <img
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex items-center mt-2">
                                    ...
                                    <span className="flex items-center ml-auto">
                                        <div
                                            className={`w-2.5 h-2.5 rounded-full mr-2 ${restaurant.open ? 'bg-green-500' : 'bg-red-500'}`}
                                        ></div>
